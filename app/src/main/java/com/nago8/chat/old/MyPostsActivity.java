...
public class MyPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvTitle.setText(R.string.my_posts_title);
        tvEmpty.setText(R.string.my_posts_empty);
    ...
    private void loadPosts(boolean showLoadingProgress) {
        ...
        if (fetchCall != null) fetchCall.cancel();
        fetchCall = communityRepository.getMyPostList(token, currentPage, PAGE_SIZE, new CommunityRepository.StringCallback() {
            @Override
            ...
            public void onError(String msg) {
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(MyPostsActivity.this, errorText, Toast.LENGTH_SHORT).show();
                });
            }
        });
    }
